...
FAMILIES = [
    "skilled_trades","construction_built_environment","digital_product_technology",
    "data_ai_analytics","healthcare_clinical","care_social_support","education_training",
    ...
    "business_operations_commercial","hospitality_retail_service",
    "beauty_wellness_personal_services","agriculture_land_animal","elite_competitive_long_route",
]
ARCHETYPES = [
...
FAMILY_RULES = [
    ...
    (phrase("chief ai officer","caio","computer repair","identity & access","identity and access","online learning designer","learning experience designer","educational technologist","performance analyst","trust and safety","virtual assistant","healthcare ai","computer vision engineer","embedded systems","construction technology specialist","e-commerce manager","ecommerce manager","chief technology"), "digital_product_technology"),
    (phrase("consumer behaviour","clinical coder","polling analyst","climate risk modeller","impact and evaluation"), "data_ai_analytics"),
    ...
    (phrase("catering manager","food and beverage","restaurant manager","revenue manager (hotel","spa manager","spa therapist","store assistant manager","venue manager","wilderness guide","expedition leader","mountain leader"), "hospitality_retail_service"),
    (phrase("body piercer","brow technician","lash technician","microblading","pmu artist","spray tan","tattoo removal","wellness coach","domestic cleaner","cleaning business"), "beauty_wellness_personal_services"),
    ...
    (phrase("acupunctur","homeopath","reflexolog","aromatherap","herbalist","nutritionist","hairdresser","barber","hair stylist","colourist","beautician","beauty therap","nail technician","manicurist","aesthetic practitioner","aesthetician","aesthetics","botox","dermal filler","laser therap","electrolysis","massage therap","masseur","personal trainer","fitness instructor","yoga","pilates","zumba","spin instructor","gym instructor","wellbeing","life coach","reiki","spiritual","holistic","hypnotherap","nlp practitioner","tarot","astrolog","salon owner"), "beauty_wellness_personal_services"),
    ...
    # Data / AI / analytics
    (phrase("data scientist","data analyst","data engineer","analytics engineer","business intelligence","bi analyst","bi developer","insight analyst","statistician","biostatistician","econometrician","quantitative","data architect","data governance","data protection","analytics manager","research analyst (data","machine learning","mlops","ai research","ai engineer","ai safety","ai ethics","ai product","ai auditor","ai compliance","ai literacy","ai trainer","ai data","generative ai","prompt engineer","natural language processing","nlp engineer"), "data_ai_analytics"),

    # Digital / product / technology (after data_ai so "data" wins)
    (phrase("software engineer","software developer","software architect","full stack","frontend","front-end","backend","back-end","web developer","mobile developer","ios developer","android developer","game developer","game programmer","game designer","game qa","embedded developer","firmware","devops","site reliability","platform engineer","cloud engineer","cloud architect","cloud security","solutions architect","systems architect","infrastructure engineer","network engineer","network administrator","systems administrator","database administrator"," dba","qa engineer","test engineer","software tester","automation tester","release engineer","build engineer"), "digital_product_technology"),
    (phrase("product manager","product owner","product designer","ux designer","ui designer","user experience","user researcher","ux researcher","service designer","interaction designer","design systems","scrum master","delivery manager","technical program"), "digital_product_technology"),
    (phrase("technical writer","developer relations","devrel","technical account"), "digital_product_technology"),
    (phrase("it support","helpdesk","service desk","desktop support","it technician","it manager","it director","cio","cto","information technology"), "digital_product_technology"),
    (phrase("cyber","cybersecurity","information security","infosec","penetration tester","pen tester","ethical hacker","soc analyst","security operations","security engineer","security architect","security consultant","incident response","threat intel","malware","digital forensic"), "digital_product_technology"),
    (phrase("blockchain","web3","smart contract","crypto","digital twin","augmented reality","virtual reality"," xr ","ar/vr","metaverse","robotics engineer","robotics technician","autonomous vehicle","semiconductor engineer","fpga"), "digital_product_technology"),
    (phrase("digital transformation","digital strategy","digital campaign","digital marketing","digital consultant","digital producer","digital editor","digital product"), "digital_product_technology"),
...
DEFAULT_ARCH_BY_FAMILY = {
    ...
    "digital_product_technology":"portfolio_led",
    "data_ai_analytics":"degree_led",
    ...
    "hospitality_retail_service":"employer_training_led",
    "beauty_wellness_personal_services":"apprenticeship_led",
