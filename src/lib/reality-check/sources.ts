...
export const SOURCES: Readonly<Record<string, SourceEntry>> = Object.freeze({
  ...
  ifate_software_developer: {
    id: "ifate_software_developer",
    organisation: "Institute for Apprenticeships & Technical Education / Skills England",
    title: "Software Developer apprenticeship standard (Level 4)",
    period: "Current",
    lastChecked: "2026-07-01",
    url: "https://www.instituteforapprenticeships.org/apprenticeship-standards/software-developer-v1-2",
    usage: "Referenced when explaining Level 4 software-development apprenticeship entry expectations.",
    category: "apprenticeship",
  },
  ifate_software_dev_technician: {
    id: "ifate_software_dev_technician",
    organisation: "Institute for Apprenticeships & Technical Education / Skills England",
    title: "Software Development Technician apprenticeship standard",
    period: "Current",
    lastChecked: "2026-07-01",
    url: "https://www.instituteforapprenticeships.org/apprenticeship-standards/software-development-technician-v1-1",
    usage: "Referenced when explaining sub-degree-level software apprenticeship routes.",
    category: "apprenticeship",
  },
  ifate_dtsp_software_engineer: {
    id: "ifate_dtsp_software_engineer",
    organisation: "Institute for Apprenticeships & Technical Education / Skills England",
    title: "Digital and Technology Solutions Professional apprenticeship (Level 6) — Software Engineer specialism",
    period: "Current",
    lastChecked: "2026-07-01",
    ...
    usage: "Referenced when explaining Level 6 degree-level software engineering apprenticeship routes.",
    category: "apprenticeship",
  },
  gov_skills_bootcamps: {
    id: "gov_skills_bootcamps",
    organisation: "Department for Education",
    title: "Skills Bootcamps",
    period: "Current",
    lastChecked: "2026-07-01",
    url: "https://www.gov.uk/guidance/free-courses-for-jobs",
    usage: "Referenced when explaining eligibility and expectations for government-funded coding bootcamps.",
    category: "pathway",
  },
  uk_enic: {
    id: "uk_enic",
    organisation: "UK ENIC",
    title: "Statement of Comparability",
    period: "Current",
    lastChecked: "2026-07-01",
    url: "https://www.enic.org.uk/",
    usage: "Referenced when international qualifications need mapping to UK equivalents before scoring a route.",
    category: "regulation",
  },
  gov_student_finance_ug: {
    id: "gov_student_finance_ug",
    organisation: "GOV.UK",
    title: "Student finance for undergraduates",
    period: "Current academic year",
    lastChecked: "2026-07-01",
    url: "https://www.gov.uk/student-finance",
    usage: "Referenced when quoting undergraduate tuition fee loan bands in degree-route caveats.",
    category: "pathway",
  },
  nmc_becoming_a_nurse: {
    id: "nmc_becoming_a_nurse",
    organisation: "Nursing and Midwifery Council",
    title: "Becoming a nurse or midwife",
    period: "Current",
    lastChecked: "2026-07-08",
    url: "https://www.nmc.org.uk/education/becoming-a-nurse-or-midwife/",
    usage: "Statutory registration, approved programmes, and health & good-character requirements for UK nurses.",
    category: "regulation",
  },
  nmc_overseas: {
    id: "nmc_overseas",
    organisation: "Nursing and Midwifery Council",
    title: "Trained outside the UK / overseas registration",
    period: "Current",
    lastChecked: "2026-07-08",
    url: "https://www.nmc.org.uk/registration/joining-the-register/trained-outside-the-eueea/",
    usage: "Overseas-trained nurse registration: evidence, English-language, CBT/OSCE Test of Competence.",
    category: "regulation",
  },
  nmc_return_to_practice: {
    id: "nmc_return_to_practice",
    organisation: "Nursing and Midwifery Council",
    title: "Returning to practice",
    period: "Current",
    lastChecked: "2026-07-08",
    url: "https://www.nmc.org.uk/education/returning-to-the-register/",
    usage: "Return-to-practice programme requirement for previously registered nurses whose registration has lapsed.",
    category: "regulation",
  },
  skills_england_rnda: {
    id: "skills_england_rnda",
    organisation: "Skills England / Institute for Apprenticeships & Technical Education",
    title: "Registered Nurse Degree Apprenticeship (Level 6) standard",
    period: "Current",
    lastChecked: "2026-07-08",
    url: "https://www.instituteforapprenticeships.org/apprenticeship-standards/registered-nurse-degree-v1-2",
