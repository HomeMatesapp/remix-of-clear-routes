...
import {
  ...
  type HeatingEngineerEngineInput,
...
const bestRouteFor = (out: HeatingEngineerEngineOutput): RealityCheckResult["bestRoute"] => {
...
const backupRouteFor = (out: HeatingEngineerEngineOutput): RealityCheckResult["backupRoute"] => {
  const altId: HeatingEngineerRouteId | undefined = out.alternativeRouteIds[0];
  if (altId) {
...
const firstMovesFor = (out: HeatingEngineerEngineOutput): string[] => {
...
export const buildHeatingEngineerResult = (
...
export { runHeatingEngineerEngine };
export type { HeatingEngineerEngineOutput };
