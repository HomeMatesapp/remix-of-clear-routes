// Deno mirror of src/lib/reality-check/route-engines/software-engineer-flavor.ts.
import type { ModularPayloadFlavor } from "./_modular_payload.ts";

export const softwareEngineerFlavor: ModularPayloadFlavor<string> = {
  questionLabels: {
  ...
  costCaveats: {
    self_taught_portfolio: "Minimal direct cost — plan for laptop, internet and possibly paid learning platforms",
    bootcamp_intensive: "Private bootcamps typically £6,000–£12,000+; funded Skills Bootcamps may be free — confirm before paying",
    degree_computer_science: "Tuition fee loans currently around £9.5k–£9.8k/year; living costs separate",
    degree_conversion_msc: "Typically £9,000–£15,000 tuition plus living costs; postgraduate loan may apply",
    apprenticeship_digital: "Paid — you earn a wage and fees are covered by the employer/government",
  ...
  cautionCard: {
    ...
    fit: "Some private bootcamps market strong outcomes but rely on self-reported job numbers without independent audit.",
    constraint: "Paying £8,000–£12,000+ for a course that does not lead to a first developer role is one of the most expensive wrong turns in this route family.",
    checks: [
    ...
    nextAction: "Do not commit until you have written outcomes methodology, refund terms and — where possible — direct references from recent graduates.",
  },
